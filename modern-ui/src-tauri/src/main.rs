...
#[derive(Serialize)]
struct RelatorioTarefasResultado {
    caminho: String,
    pasta: String,
    turmas: usize,
    alunos: usize,
...
#[derive(Deserialize)]
struct ArquivoProvaInput {
    nome: String,
    bytes: Vec<u8>,
}

struct AlunoProvaPaulistaData {
    nome: String,
    participou: bool,
    geral: Option<u32>,
    disciplinas: BTreeMap<String, u32>,
}

fn extrair_prova_paulista_xlsx(
    bytes: &[u8],
    ...
    for linha in iter {
        ...
        let col0 = texto_celula(linha.get(0));
...
#[derive(Serialize)]
struct RelatorioProvaPaulistaResultado {
    caminho: String,
    pasta: String,
    turmas: usize,
    alunos: usize,
...
fn gerar_relatorio_prova_paulista(
    ...
    let mut linhas: Vec<(String, i64, String, bool, Option<u32>, BTreeMap<String, Option<u32>>)> =
        Vec::new();
...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            analisar_prova_paulista,
            aplicar_prova_paulista,
            gerar_relatorio_prova_paulista,
