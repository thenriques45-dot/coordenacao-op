// Dados de Escopo-Sequência do Ensino Médio, extraídos fielmente (copiados,
// não retranscritos) de planejamento_medio.gs — usados pelo Web App de
// Planejamento (ver apps_script_webapp_conteudo.rs). Identificadores com
// sufixo _MEDIO para não colidir com DadosAnosFinais.gs no mesmo projeto.
//
// "Projeto de Vida" foi adicionado aqui (não existia no .gs original) por
// aparecer nos dados reais de turma como disciplina sem Escopo-Sequência
// cadastrado — mesmo tratamento dos demais "semCurriculo: true".

const ESCOPOS_POR_COMPONENTE_MEDIO = {
  ...
  "Projeto de Vida": { "semCurriculo": true },
};

const ESTRATEGIAS_MEDIO = [
...
const INSTRUMENTOS_AVALIACAO_MEDIO = [
...
const BIMESTRES_MEDIO = ["1º Bimestre", "2º Bimestre", "3º Bimestre", "4º Bimestre"];
const COMPONENTES_MEDIO = Object.keys(ESCOPOS_POR_COMPONENTE_MEDIO).sort(function (a, b) {
